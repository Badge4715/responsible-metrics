...
-   Specify a particular source to use or a specific metric to use.
...
-   Ask the Library Research Services team if they can provide metrics for the group of candidates, so that everyone will be assessed in the same way at the same time. Please contact us: Scott Chesworth [s.chesworth\@keele.ac.uk](mailto:s.chesworth@keele.ac.uk) or Jodie Heap [j.heap\@keele.ac.uk](mailto:j.heap@keele.ac.uk) to discuss.
...
-   Lack of context:
    ...
    -   volume of citations vary across disciplines, if you are a subject expert you may have the contextual knowledge of what to expect but, if not, it can be hard to determine whether it is good or not.
...
Test your [knowledge](https://forms.office.com/e/2wiFXSSLSG){target="_blank"}. If you completed this at the end of section 3 you do not need to retake.

Read the [Read the University’s responsible metrics principles](https://keeleacuk.sharepoint.com/sites/KU-ResearchandInnovationSupport/SitePages/Responsible-Research.aspx){target="_blank"}

Specific question? Contact the Library Research Services team: Scott Chesworth [s.chesworth\@keele.ac.uk](mailto:s.chesworth@keele.ac.uk) or Jodie Heap [j.heap\@keele.ac.uk](mailto:j.heap@keele.ac.uk).
