...
-   Ask the Library Research Services team if they can provide metrics for the group of candidates, so that everyone will be assessed in the same way at the same time. Please contact us at [s.chesworth\@keele.ac.uk](mailto:s.chesworth@keele.ac.uk) to discuss.
...
Specific question? Contact the Library Research Services team: Scott Chesworth [s.chesworth\@keele.ac.uk](mailto:s.chesworth@keele.ac.uk) (s.chesworth@keele.ac.uk) or Jodie Heap [j.heap\@keele.ac.uk](mailto:j.heap@keele.ac.uk).
