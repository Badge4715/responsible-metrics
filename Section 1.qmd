...
In this first section you will explore the following areas:
...
A number of guidelines have been published which look to shape our approach to responsible metrics.  The University has its own set of principles [Read the University’s responsible metrics principles](https://keeleacuk.sharepoint.com/sites/KU-ResearchandInnovationSupport/SitePages/Responsible-Research.aspx){target="_blank"} which is based on the principles of DORA and the Leiden Manifesto (<https://doi.org/10.1038/520429a>). Below are summaries of three key international initiatives, each of which advise on a different aspect: 
...
Keele University is a signatory of DORA.
...
Specific question? Contact the Library Research Services team: Scott Chesworth [s.chesworth\@keele.ac.uk](mailto:s.chesworth@keele.ac.uk) or Jodie Heap [j.heap\@keele.ac.uk](mailto:j.heap@keele.ac.uk) (j.heap@keele.ac.uk).
